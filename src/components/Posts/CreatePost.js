    ...
    return (
     ...
     <h3><strong>Create Post</strong></h3>
        ...
        <FormGroup row>
          ...
          <Col sm={10}>
            <Input type="text" name="title" id="title" placeholder="Title" onChange={this.setTitle.bind(this)}/>
          </Col>
        </FormGroup>
        <FormGroup row>
          <Label for="body" sm={2}>Body</Label>
          <Col sm={10}>
            <Input type="textarea" name="body" id="body" placeholder="Body" onChange={this.setBody.bind(this)}/>
          </Col>
        </FormGroup>
        <FormGroup row>
